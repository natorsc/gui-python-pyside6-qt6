# -*- coding: utf-8 -*-
"""Python e Qt 6: PySide6 QDateTimeEdit() com QUiLoader()."""
...
class MainWindow(QtCore.QObject):
    ...
    def __init__(self, application):
        ...
        self.ui.date_time_edit.setDateTime(date_time_now)
        self.ui.date_time_edit.dateTimeChanged.connect(
            self.on_date_time_changed
        )
