# -*- coding: utf-8 -*-
"""Python e Qt 6: PySide6 QSlider() com QUiLoader()."""
...
class MainWindow(QtCore.QObject):
    ...
    def __init__(self, application):
        ...
        self.ui.hslider.sliderMoved.connect(self.on_slider_moved)
        self.ui.vslider.sliderMoved.connect(self.on_slider_moved)
