# -*- coding: utf-8 -*-
"""Python e Qt 6: PySide6 QSlider() com loadUiType()."""
...
class MainWindow(BaseQMainWindow, UiMainWindow):
    ...
    def __init__(self, application):
        ...
        self.hslider.sliderMoved.connect(self.on_slider_moved)
        self.vslider.sliderMoved.connect(self.on_slider_moved)
