# -*- coding: utf-8 -*-
"""Python e Qt 6: PySide6 QToolBar() com QUiLoader()."""
...
class MainWindow(QtCore.QObject):
    ...
    def __init__(self, application):
        ...
        self.ui.action_copy.triggered.connect(self.on_action_copy_clicked)
        self.ui.action_cut.triggered.connect(self.on_action_cut_clicked)
        self.ui.action_about_qt.triggered.connect(
            self.on_action_about_qt_clicked
        )
