# -*- coding: utf-8 -*-
"""Python e Qt 6: PySide6 QToolBar() com loadUiType()."""
...
class MainWindow(BaseQMainWindow, UiMainWindow):
    ...
    def __init__(self, application):
        ...
        self.action_copy.triggered.connect(self.on_action_copy_clicked)
        self.action_cut.triggered.connect(self.on_action_cut_clicked)
        self.action_about_qt.triggered.connect(self.on_action_about_qt_clicked)
